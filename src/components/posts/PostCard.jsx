...
const PostCard = ({ post }) => {
  ...
  // });
  const saveHandler = () => {
    instance.post("/save", { postSave }).then((response) => {
  ...
  return (
    <>
      <div className="-z-20 bg-[#FFFFFF] flex flex-col shrink px-8  h-auto mb-10 min-w-[300px] py-8 max-w-[450px] mx-auto shadow-[0_35px_60px_-14px_rgba(0,0,0,0.2)]  mt-12    rounded-lg ">
        <div className="flex">
          <img
          ...
          <div>
            ...
            <h1 className="font-normal text-xs">{format(post.createdAt)}</h1>
          </div>
        </div>
